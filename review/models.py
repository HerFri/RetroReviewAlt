...
class Game(models.Model):
    ...
    genre = models.CharField(max_length=100, choices=GENRES, default="")
    year = models.IntegerField(choices=YEARS, default=1980)
    platform = models.CharField(max_length=100, choices=PLATFORMS, default="")
